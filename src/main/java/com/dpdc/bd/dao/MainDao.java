...
import com.dpdc.bd.model.BillGroupModel;
import com.dpdc.bd.model.LocationModel;
import com.dpdc.bd.model.MRSEntryModel;
...
public class MainDao {
	...
	public ArrayList<LocationModel> location(String id) {
		...
		Map<String, Object> result = getAllStatesJdbcCall3.withCatalogName("DPG_NET_MRS_ENTRY")
	...
	public ArrayList<BillGroupModel> billgroup(String id) {
		...
		Map<String, Object> result = getAllStatesJdbcCall4.withCatalogName("DPG_NET_MRS_ENTRY")
	...
	public ArrayList<MRSEntryModel> funMrsEntry1(ArrayList<String> CUST_ID, ArrayList<String> BILL_CYCLE_CODE,
		...
		Map<String, Object> result = getAllStatesJdbcCall2.withCatalogName("DPG_NET_MRS_ENTRY")
				.withProcedureName("DPD_NET_MRS_DATA_GRID")
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			...
			mrsEntryModels.add(new MRSEntryModel(jsonData.optString("CUST_ID"), jsonData.optString("CUSTOMER_NUM"),
					...
					jsonData.optString("TARIFF"),jsonData.optString("SOURCE_TYPE"),jsonData.optString("METER_READING_ID")));
			// }
...
//						PRE_PK_RDNG.get(i1), "lol", PK_ADV.get(i1), "lol", BILL_CYCLE_CODE.get(i1), "lol"));
	...
	public ArrayList<MRSEntryModel> funMrsEntry(String billcycle, String location, String billgrp, String book,
		...
		for (int i = 0; i < jsonArray.length(); i++) {
			JSONObject jsonData = jsonArray.getJSONObject(i);
			mrsEntryModels.add(new MRSEntryModel(jsonData.optString("CUST_ID"), jsonData.optString("CONSUMER_NUM"),
					jsonData.optString("CUSTOMER_NAME"), jsonData.optString("METER_NUM"),
					...
					jsonData.optString("PREV_AC_NO"),
					formatter.format(Date.valueOf(jsonData.optString("PRE_RDG_DATE").replace(" 00:00:00.0", ""))),
					jsonData.optString("USAGE_CATEGORY_CODE"),jsonData.optString("SOURCE_TYPE"),jsonData.optString("METER_READING_ID")));
		}
	...
	public int updateMrsData(ArrayList<String> CUST_ID, ArrayList<String> BILL_CYCLE_CODE,
			ArrayList<String> PRE_READING, ArrayList<String> ADV, ArrayList<String> PRE_OFPK_RDNG,
			ArrayList<String> OFPK_ADV, ArrayList<String> PRE_PK_RDNG, ArrayList<String> PK_ADV,
			ArrayList<String> MTR_COND,ArrayList<String> METER_READING_ID, String id) {
		...
		String ten[] = optStringArray(METER_READING_ID);
		ArrayDescriptor des1, des2, des3, des4, des5, des6, des7, des8, des9,des10;
		ARRAY aOne = null, aTwo = null, aThree = null, aFour = null, aFive = null, aSix = null, aSeven = null,
				aEight = null, aNine = null,aTen=null;
		CallableStatement st = null;
		int out = 0;
		try {
			Class.forName("oracle.jdbc.OracleDriver");
			Connection con = DriverManager.getConnection("jdbc:oracle:thin:@172.16.1.80:1521/bpdbtestdb.bpdb.gov.bd", "EMP", "EMP");
			des1 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CUST_ID", con);
			aOne = new ARRAY(des1, con, one);
			des2 = ArrayDescriptor.createDescriptor("EMP.ARRAY_BILL_CYCLE_CODE", con);
			aTwo = new ARRAY(des2, con, two);
			des3 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CLS_KWH_SR_RDNG", con);
			aThree = new ARRAY(des3, con, three);
			des4 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CONS_KWH_SR", con);
			aFour = new ARRAY(des4, con, four);
			des5 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CLS_KWH_OFPK_RDNG", con);
			aFive = new ARRAY(des5, con, five);
			des6 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CONS_KWH_OFPK", con);
			aSix = new ARRAY(des6, con, six);
			des7 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CLS_KWH_PK_RDNG", con);
			aSeven = new ARRAY(des7, con, seven);
			des8 = ArrayDescriptor.createDescriptor("EMP.ARRAY_CONS_KWH_PK", con);
			aEight = new ARRAY(des8, con, eight);
			des9 = ArrayDescriptor.createDescriptor("EMP.ARRAY_METER_COND_KWH", con);
			aNine = new ARRAY(des9, con, nine);
			des10 = ArrayDescriptor.createDescriptor("EMP.ARRAY_METER_READING_ID", con);
			aTen = new ARRAY(des10, con, ten);
			st = con.prepareCall("call DPG_NET_MRS_ENTRY.DPD_NET_MRS_DATA_SAVE(?,?,?,?,?,?,?,?,?,?,?,?)");
