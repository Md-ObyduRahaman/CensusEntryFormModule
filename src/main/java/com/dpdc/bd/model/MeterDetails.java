...
public class MeterDetails {
	private String REF_CUSTOMER_NUM;
	...
	public String getREF_CUSTOMER_NUM() {
		return REF_CUSTOMER_NUM;
	}




	public void setREF_CUSTOMER_NUM(String rEF_CUSTOMER_NUM) {
		REF_CUSTOMER_NUM = rEF_CUSTOMER_NUM;
	}
	...
	public String toString() {
		return "MeterDetails [REF_CUSTOMER_NUM=" + REF_CUSTOMER_NUM + ", OLD_METER_TYPECODE=" + OLD_METER_TYPECODE
				+ ", METER_TYPE_DESC=" + METER_TYPE_DESC + ", MANUF_CODE=" + MANUF_CODE + ", MANUF_NAME=" + MANUF_NAME
				+ ", LOCATON_DESCR=" + LOCATON_DESCR + ", METER_LOCATION_CODE=" + METER_LOCATION_CODE + ", DESCR="
				+ DESCR + ", RATED_CURRENT_CODE=" + RATED_CURRENT_CODE + ", DEFECTIVE_CODE=" + DEFECTIVE_CODE
				+ ", DEFECTIVE_DESC=" + DEFECTIVE_DESC + ", METER_OWNER=" + METER_OWNER + ", METER_TYPE=" + METER_TYPE
				+ ", CREATE_BY=" + CREATE_BY + ", METER_MFG_DATE=" + METER_MFG_DATE + ", METER_INST_DATE="
				+ METER_INST_DATE + ", METER_NUM=" + METER_NUM + ", METER_DIGIT_KW=" + METER_DIGIT_KW
				+ ", METER_INT_ID=" + METER_INT_ID + ", METER_DIGIT_CUM=" + METER_DIGIT_CUM + ", METER_DIGIT="
				+ METER_DIGIT + ", CURR_RATING=" + CURR_RATING + ", VOLT_VALUE=" + VOLT_VALUE + ", METER_CONDITION="
				+ METER_CONDITION + ", ASSOCIATED_KWH_METER_NUM=" + ASSOCIATED_KWH_METER_NUM + ", SCALE_FACTOR_KW="
				+ SCALE_FACTOR_KW + ", SCALE_FACTOR_KVARH=" + SCALE_FACTOR_KVARH + ", SCALE_FACTOR_KVA="
				+ SCALE_FACTOR_KVA + ", PT_NUMERATOR=" + PT_NUMERATOR + ", CT_NUMERATOR=" + CT_NUMERATOR
				+ ", OVERALL_MF_KWH=" + OVERALL_MF_KWH + ", OVERALL_MF_KW=" + OVERALL_MF_KW + ", OVERALL_MF_KVARH="
				+ OVERALL_MF_KVARH + ", OVERALL_MF_KVA=" + OVERALL_MF_KVA + ", METER_SEAL=" + METER_SEAL
				+ ", PROT_TYPE=" + PROT_TYPE + ", TIME_SWITCH_NUM=" + TIME_SWITCH_NUM + ", TIME_SWITCH_START="
				+ TIME_SWITCH_START + ", TIME_SWITCH_SEAL=" + TIME_SWITCH_SEAL + ", METER_MAKE=" + METER_MAKE
				+ ", METER_LOC=" + METER_LOC + "]";
	}
